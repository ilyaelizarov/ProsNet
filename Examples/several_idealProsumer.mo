...
package several_idealProsumer
  package Simulations
    ...
    model Speer_IEWT2023 "Producer and Consumer with Controller"
      ...
      ProsNet.Fluid.Pipes.InsulatedPipe Pipe_ID_2_pipe_hot_12(
      ...
      ProsNet.Fluid.Pipes.InsulatedPipe Pipe_ID_2_pipe_cold_12(
        allowFlowReversal=true,
        T_amb=system.T_ambient,
        R_ins=1000,
        length=40,
      ...
      BidirectionalSubstation.Substation_idealProsumer.Controller_PID_based.PID_Q_T_weighted_sameside
        Controller_1(
        Delta_Qdot_norm=1,
        Delta_T_norm=3,
      ...
      ProsNet.Fluid.Pipes.InsulatedPipe Pipe_ID_4_pipe_cold_23(
        allowFlowReversal=true,
        T_amb=system.T_ambient,
        R_ins=1000,
        length=40,
      ...
      ProsNet.Fluid.Pipes.InsulatedPipe Pipe_ID_4_pipe_hot_23(
        allowFlowReversal=true,
        T_amb=system.T_ambient,
        R_ins=1000,
        length=40,
      ...
      ProsNet.Fluid.Pipes.InsulatedPipe Pipe_ID_6_pipe_hot_34(
        allowFlowReversal=true,
        T_amb=system.T_ambient,
        R_ins=1000,
        length=49.5,
      ...
      ProsNet.Fluid.Pipes.InsulatedPipe Pipe_ID_6_pipe_cold_34(
        allowFlowReversal=true,
        T_amb=system.T_ambient,
        R_ins=1000,
        length=49.5,
      ...
      ProsNet.Fluid.Pipes.InsulatedPipe Pipe_ID_8_pipe_hot_45(
        allowFlowReversal=true,
        T_amb=system.T_ambient,
        R_ins=1000,
        length=46.5,
      ...
      ProsNet.Fluid.Pipes.InsulatedPipe Pipe_ID_8_pipe_cold_45(
        allowFlowReversal=true,
        T_amb=system.T_ambient,
        R_ins=1000,
        length=46.5,
...
SF1"),      Text(
    ...
    model A1b_Licklederer_crossover_noheat_defweight
      ...
      BidirectionalSubstation.Substation_idealProsumer.Controller_PID_based.auxiliary.TimeTable_noInterp
        temp_sec_in3(table=[0,55; 3600,30; 7200,30; 10800,55; 14400,30; 18000,
            ...
            origin={172,138})));
      BidirectionalSubstation.Substation_idealProsumer.Controller_PID_based.PID_Q_T_weighted_crossover
        Ctrl1 annotation (Placement(transformation(extent={{-58,48},{-34,82}})));
      BidirectionalSubstation.Substation_idealProsumer.Controller_PID_based.PID_Q_T_weighted_crossover
        Ctrl2 annotation (Placement(transformation(extent={{40,48},{64,82}})));
      BidirectionalSubstation.Substation_idealProsumer.Controller_PID_based.PID_Q_T_weighted_crossover
        Ctrl3 annotation (Placement(transformation(extent={{134,50},{158,84}})));
    equation
      connect(B1.hot_prim, pipe_hot12.port_a)
        annotation (Line(points={{-34,-10.2},{-34,-45},{-8,-45}}, color={0,127,255}));
      connect(pipe_hot12.port_b, B2.hot_prim)
    ...
    model A2a_Licklederer_crossover_heat_noweight
      ...
      BidirectionalSubstation.Substation_idealProsumer.new_prosumer_models.heat_transfer_station
        ...
        R_ins_transferpipe=5) annotation (Placement(transformation(
            ...
            rotation=0,
            origin={148,8})));
      ProsNet.Fluid.Pipes.InsulatedPipe_plug pipe_hot23(R_ins=5, length=100)
        annotation (Placement(transformation(extent={{88,-58},{114,-32}})));
      ProsNet.Fluid.Pipes.InsulatedPipe_plug pipe_cold23(R_ins=5, length=100)
        annotation (Placement(transformation(extent={{114,-103},{88,-77}})));
      ProsNet.Fluid.Pipes.InsulatedPipe_plug pipe_cold12(R_ins=5, length=100)
        annotation (Placement(transformation(extent={{18,-103},{-8,-77}})));
      Modelica.Fluid.Sources.Boundary_pT boundary(
        redeclare package Medium = ProsNet.Media.Water,
        use_p_in=false,
    ...
    model B1b_Licklederer_sameside_noheat_defweight
      BidirectionalSubstation.Substation_idealProsumer.new_prosumer_models.heat_transfer_station
        ...
        R_ins_transferpipe=100000) annotation (Placement(transformation(
            ...
            origin={-48,8})));
      BidirectionalSubstation.Substation_idealProsumer.Controller_PID_based.PID_Q_T_weighted_sameside
        Ctrl1 annotation (Placement(transformation(
            extent={{-12,-17},{12,17}},
            rotation=0,
            origin={-42,75})));
      ProsNet.Fluid.Pipes.InsulatedPipe_plug pipe_hot12(R_ins=100000, length=
      ...
      BidirectionalSubstation.Substation_idealProsumer.new_prosumer_models.heat_transfer_station
        ...
        R_ins_transferpipe=100000) annotation (Placement(transformation(
            ...
            origin={50,8})));
      BidirectionalSubstation.Substation_idealProsumer.Controller_PID_based.PID_Q_T_weighted_sameside
        Ctrl2 annotation (Placement(transformation(
            extent={{-12,-17},{12,17}},
            rotation=0,
            origin={52,73})));
      BidirectionalSubstation.Substation_idealProsumer.new_prosumer_models.heat_transfer_station
        ...
        R_ins_transferpipe=100000) annotation (Placement(transformation(
            ...
            origin={148,8})));
      BidirectionalSubstation.Substation_idealProsumer.Controller_PID_based.PID_Q_T_weighted_sameside
        Ctrl3 annotation (Placement(transformation(
            extent={{-12,-17},{12,17}},
            rotation=0,
            origin={148,71})));
      ProsNet.Fluid.Pipes.InsulatedPipe_plug pipe_hot23(R_ins=100000, length=
    ...
    model C1a_Licklederer_mix1_noheat_noweight
      ...
      BidirectionalSubstation.Substation_idealProsumer.Controller_PID_based.auxiliary.TimeTable_noInterp
        temp_sec_in3(table=[0,55; 3600,30; 7200,30; 10800,55; 14400,30; 18000,
            ...
            rotation=-90,
            origin={172,138})));
      BidirectionalSubstation.Substation_idealProsumer.Controller_PID_based.PID_Q_T_weighted_mix1
        Ctrl1(
        alpha_prim_prod=0,
        alpha_sec_prod=1,
        alpha_prim_cons=0,
    ...
    model C1b_Licklederer_mix1_noheat_defweight
      ...
      BidirectionalSubstation.Substation_idealProsumer.Controller_PID_based.auxiliary.TimeTable_noInterp
        temp_sec_in3(table=[0,55; 3600,30; 7200,30; 10800,55; 14400,30; 18000,
            ...
            origin={172,138})));
      BidirectionalSubstation.Substation_idealProsumer.Controller_PID_based.PID_Q_T_weighted_mix1
        Ctrl1 annotation (Placement(transformation(extent={{-58,50},{-34,84}})));
      BidirectionalSubstation.Substation_idealProsumer.Controller_PID_based.PID_Q_T_weighted_mix1
        Ctrl2 annotation (Placement(transformation(extent={{34,42},{58,76}})));
      BidirectionalSubstation.Substation_idealProsumer.Controller_PID_based.PID_Q_T_weighted_mix1
        Ctrl3 annotation (Placement(transformation(extent={{132,50},{156,84}})));
    equation
      connect(B1.hot_prim, pipe_hot12.port_a)
        annotation (Line(points={{-34,-10.2},{-34,-45},{-8,-45}}, color={0,127,255}));
      connect(pipe_hot12.port_b, B2.hot_prim)
    ...
    model C3b_Licklederer_mix1_smallpump_defweight
      ...
      BidirectionalSubstation.Substation_idealProsumer.Controller_PID_based.auxiliary.TimeTable_noInterp
        temp_sec_in3(table=[0,55; 3600,30; 7200,30; 10800,55; 14400,30; 18000,
            ...
            origin={172,138})));
      BidirectionalSubstation.Substation_idealProsumer.Controller_PID_based.PID_Q_T_weighted_mix1
        Ctrl1 annotation (Placement(transformation(extent={{-54,48},{-30,82}})));
      BidirectionalSubstation.Substation_idealProsumer.Controller_PID_based.PID_Q_T_weighted_mix1
        Ctrl2 annotation (Placement(transformation(extent={{38,44},{62,78}})));
      BidirectionalSubstation.Substation_idealProsumer.Controller_PID_based.PID_Q_T_weighted_mix1
        Ctrl3 annotation (Placement(transformation(extent={{136,44},{160,78}})));
    equation
      connect(B1.hot_prim, pipe_hot12.port_a)
        annotation (Line(points={{-34,-10.2},{-34,-45},{-8,-45}}, color={0,127,255}));
      connect(pipe_hot12.port_b, B2.hot_prim)
    ...
    model D1a_Licklederer_mix2_noheat_noweight
      ...
      BidirectionalSubstation.Substation_idealProsumer.Controller_PID_based.auxiliary.TimeTable_noInterp
        temp_sec_in3(table=[0,55; 3600,30; 7200,30; 10800,55; 14400,30; 18000,
            ...
            rotation=-90,
            origin={172,138})));
      BidirectionalSubstation.Substation_idealProsumer.Controller_PID_based.PID_Q_T_weighted_mix2
        Ctrl1(
        alpha_prim_prod=1,
        alpha_sec_prod=0,
        alpha_prim_cons=1,
    ...
    model D1b_Licklederer_mix2_noheat_defweight
      ...
      BidirectionalSubstation.Substation_idealProsumer.Controller_PID_based.auxiliary.TimeTable_noInterp
        temp_sec_in3(table=[0,55; 3600,30; 7200,30; 10800,55; 14400,30; 18000,
            ...
            origin={172,138})));
      BidirectionalSubstation.Substation_idealProsumer.Controller_PID_based.PID_Q_T_weighted_mix2
        Ctrl1 annotation (Placement(transformation(extent={{-60,44},{-36,78}})));
      BidirectionalSubstation.Substation_idealProsumer.Controller_PID_based.PID_Q_T_weighted_mix2
        Ctrl2 annotation (Placement(transformation(extent={{50,44},{74,78}})));
      BidirectionalSubstation.Substation_idealProsumer.Controller_PID_based.PID_Q_T_weighted_mix2
        Ctrl3 annotation (Placement(transformation(extent={{138,44},{162,78}})));
    equation
      connect(B1.hot_prim, pipe_hot12.port_a)
        annotation (Line(points={{-34,-10.2},{-34,-45},{-8,-45}}, color={0,127,255}));
      connect(pipe_hot12.port_b, B2.hot_prim)
    ...
    model D2b_Licklederer_mix2_heat_defweight
      ...
      BidirectionalSubstation.Substation_idealProsumer.Controller_PID_based.auxiliary.TimeTable_noInterp
        temp_sec_in3(table=[0,55; 3600,30; 7200,30; 10800,55; 14400,30; 18000,
            ...
            origin={172,138})));
      BidirectionalSubstation.Substation_idealProsumer.Controller_PID_based.PID_Q_T_weighted_mix2
        Ctrl1 annotation (Placement(transformation(extent={{-68,46},{-44,80}})));
      BidirectionalSubstation.Substation_idealProsumer.Controller_PID_based.PID_Q_T_weighted_mix2
        Ctrl2 annotation (Placement(transformation(extent={{42,46},{66,80}})));
      BidirectionalSubstation.Substation_idealProsumer.Controller_PID_based.PID_Q_T_weighted_mix2
        Ctrl3 annotation (Placement(transformation(extent={{132,48},{156,82}})));
    equation
      connect(B1.hot_prim, pipe_hot12.port_a)
        annotation (Line(points={{-34,-10.2},{-34,-45},{-8,-45}}, color={0,127,255}));
      connect(pipe_hot12.port_b, B2.hot_prim)
    ...
    model D3b_Licklederer_mix2_smallpump_defweight
      ...
      BidirectionalSubstation.Substation_idealProsumer.Controller_PID_based.PID_Q_T_weighted_mix2
        Ctrl1 annotation (Placement(transformation(extent={{-54,48},{-30,82}})));
      BidirectionalSubstation.Substation_idealProsumer.Controller_PID_based.PID_Q_T_weighted_mix2
        Ctrl2 annotation (Placement(transformation(extent={{38,46},{62,80}})));
      BidirectionalSubstation.Substation_idealProsumer.Controller_PID_based.PID_Q_T_weighted_mix2
        Ctrl3 annotation (Placement(transformation(extent={{134,50},{158,84}})));
    equation
      connect(B1.hot_prim, pipe_hot12.port_a)
