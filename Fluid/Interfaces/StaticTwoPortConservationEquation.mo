within ProsNet.Fluid.Interfaces;
...
equation
  ...
  if use_m_flowInv then
    m_flowInv = ProsNet.Utilities.Math.Functions.inverseXRegularized(
                       x=port_a.m_flow,
  ...
  if allowFlowReversal then
    ...
    hOut = ProsNet.Utilities.Math.Functions.regStep(y1=port_b.h_outflow,
                                                    y2=port_a.h_outflow,
                                                    x=port_a.m_flow,
                                                    x_small=m_flow_small/1E3);
    XiOut = ProsNet.Utilities.Math.Functions.regStep(y1=port_b.Xi_outflow,
                                                     y2=port_a.Xi_outflow,
                                                     x=port_a.m_flow,
                                                     x_small=m_flow_small/1E3);
    COut = ProsNet.Utilities.Math.Functions.regStep(y1=port_b.C_outflow,
                                                    y2=port_a.C_outflow,
                                                    x=port_a.m_flow,
                                                    x_small=m_flow_small/1E3);
  else
...
<a href=\"modelica://ProsNet.Fluid.Interfaces.ConservationEquation\">
ProsNet.Fluid.Interfaces.ConservationEquation</a>.
</p>
</html>",
revisions="<html>
<ul>
