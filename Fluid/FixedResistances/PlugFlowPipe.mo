...
model PlugFlowPipe
  ...
  extends ProsNet.Fluid.Interfaces.PartialTwoPortVector;
  ...
  ProsNet.Fluid.FixedResistances.BaseClasses.PlugFlowCore cor(
  ...
  ProsNet.Fluid.MixingVolumes.MixingVolume vol(
    redeclare final package Medium = Medium,
    final m_flow_nominal=m_flow_nominal,
