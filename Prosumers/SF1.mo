...
model SF1 "Example model of a building with loads provided as time series and
  ...
  Modelica.Fluid.Interfaces.FluidPort_a port_a1
    ...
    annotation (Placement(transformation(extent={{26,220},{46,240}})));
...
equation
  ...
  connect(wolfCGB14_GC1.port_a, val3.port_1) annotation (Line(points={{-440.716,
          22.6182},{-240,22.6182},{-240,-20},{-230,-20}}, color={0,127,255}));
  ...
  connect(val3.port_2, tan.fluPorVol[1]) annotation (Line(points={{-210,-20},{
          -210,14},{-80,14},{-80,-13.62},{-74.5,-13.62}},   color={0,127,255}));
  connect(val4.port_2, tan.fluPorVol[10]) annotation (Line(points={{-142,-140},
          {-132,-140},{-132,-8},{-78,-8},{-78,7.62},{-74.5,7.62}},   color={0,
          127,255}));
  ...
  connect(sinZonFlo.weaBus, weaDat.weaBus) annotation (Line(
      ...
      color={255,204,51},
      thickness=0.5));
  connect(tan.fluPorVol1[1], buiHea.ports_aHeaWat[1]) annotation (Line(points={{5.74,
          -12.44},{5.74,12},{68,12},{68,-4},{124,-4},{124,-5.06667},{172,
  ...
  connect(ChpControl.CHPON, wolfCGB14_GC1.CBOn1) annotation (Line(points={{-632.62,
        ...
        color={255,0,255}));
  connect(tan.fluPorVol1[2],port_a1)  annotation (Line(points={{5.74,-10.08},{
          36,-10.08},{36,230}},  color={0,127,255}));
  connect(port_b1, tan.fluPorVol1[4]) annotation (Line(points={{84,226},{56,226},
          {56,-5.36},{5.74,-5.36}},                      color={0,127,255}));
  connect(port_b1,port_b1)
    annotation (Line(points={{84,226},{84,226}}, color={0,127,255}));
