...
block LimPID
  ...
  parameter ProsNet.Fluid.Building_Fluid.Utili.Types.Reset reset = ProsNet.Fluid.Building_Fluid.Utili.Types.Reset.Disabled
    "Type of controller output reset"
    annotation(Evaluate=true, Dialog(group="Integrator reset"));

  parameter Real y_reset=xi_start
    "Value to which the controller output is reset if the boolean trigger has a rising edge, used if reset == ProsNet.Fluid.Building_Fluid.Utili.Types.Reset.Parameter"
    annotation(Dialog(enable=reset == ProsNet.Fluid.Building_Fluid.Utili.Types.Reset.Parameter,
                      group="Integrator reset"));

  Modelica.Blocks.Interfaces.BooleanInput trigger
    if reset <> ProsNet.Fluid.Building_Fluid.Utili.Types.Reset.Disabled
  ...
  Modelica.Blocks.Interfaces.RealInput y_reset_in
    if reset == ProsNet.Fluid.Building_Fluid.Utili.Types.Reset.Input
    "Input signal for state to which integrator is reset, enabled if reset = ProsNet.Fluid.Building_Fluid.Utili.Types.Reset.Input"
  ...
  ProsNet.Fluid.Building_Fluid.Utili.Utilities.Math.IntegratorWithReset I(
    final reset=if reset == ProsNet.Fluid.Building_Fluid.Utili.Types.Reset.Disabled then reset else
        ProsNet.Fluid.Building_Fluid.Utili.Types.Reset.Input,
    final y_reset=y_reset,
    final k=unitTime/Ti,
    final y_start=xi_start,
    final initType=if initType == Modelica.Blocks.Types.Init.SteadyState
         then Modelica.Blocks.Types.Init.SteadyState else if initType ==
        Modelica.Blocks.Types.Init.InitialState or initType == Modelica.Blocks.Types.Init.InitialState
...
equation
  ...
  if reset <> ProsNet.Fluid.Building_Fluid.Utili.Types.Reset.Input then
