...
model SF1_TimeSeries "Example model of a building with loads provided as time series and
  ...
  Modelica.Fluid.Interfaces.FluidPort_a port_a1
    ...
    annotation (Placement(transformation(extent={{-328,68},{-150,222}}),
        iconTransformation(extent={{-328,68},{-150,222}})));
  Modelica.Fluid.Interfaces.FluidPort_b port_b1
    "Fluid connector b (positive design flow direction is from port_a to port_b)"
    annotation (Placement(transformation(extent={{94,74},{282,236}}),
        iconTransformation(extent={{94,74},{282,236}})));
...
equation
  ...
  connect(port_b1,port_b1)
    annotation (Line(points={{188,155},{188,155}},
                                                 color={0,127,255}));
  ...
  connect(val5.port_b, port_a1)
    annotation (Line(points={{-72,240},{-239,240},{-239,145}},
                                                           color={0,127,255}));
  connect(y2.y, val5.y)
