...
algorithm
  psat := ProsNet.Utilities.Psychrometrics.Functions.saturationPressure(Tsat);
  annotation (
  smoothOrder=5,
  Inline=true);
...
constant GasProperties dryair(
  ...
  cp=ProsNet.Utilities.Psychrometrics.Constants.cpAir,
  cv=ProsNet.Utilities.Psychrometrics.Constants.cpAir - Modelica.Media.IdealGases.Common.SingleGasesData.Air.R_s)
  "Dry air properties";
constant GasProperties steam(
  R=Modelica.Media.IdealGases.Common.SingleGasesData.H2O.R_s,
  MM=Modelica.Media.IdealGases.Common.SingleGasesData.H2O.MM,
  cp=ProsNet.Utilities.Psychrometrics.Constants.cpSte,
  cv=ProsNet.Utilities.Psychrometrics.Constants.cpSte - Modelica.Media.IdealGases.Common.SingleGasesData.H2O.R_s)
  "Steam properties";
...
constant Modelica.Units.SI.SpecificEnergy h_fg=ProsNet.Utilities.Psychrometrics.Constants.h_fg
  "Latent heat of evaporation of water";
constant Modelica.Units.SI.SpecificHeatCapacity cpWatLiq=ProsNet.Utilities.Psychrometrics.Constants.cpWatLiq
