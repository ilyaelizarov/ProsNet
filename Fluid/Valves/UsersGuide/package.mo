within ProsNet.Fluid.Valves;

package UsersGuide "User's Guide"
  extends Modelica.Icons.Information;
  annotation (preferredView="info",
  Documentation(info= "<html><head></head><body><h4>Pressure drop of valves</h4>
<p>
All valves have a parameter
...
<p align=\"center\">
<img alt=\"image\" src=\"modelica://IBPSA/Resources/Images/Fluid/Actuators/valvePressureDropSeries.png\">
</p>
<p>
...
<pre>  val(dpValve_nominal=6000, dpFixed=0, m_flow_nominal=0.1);
...
<pre>  val(dpValve_nominal=6000, dpFixed=10000, m_flow_nominal=0.1);
</pre>
<p>
...
a nonlinear equation can be worthwhile.</p>
<h4>Leakage flow rate</h4>
<p>
Valves should for numerical reasons have a small leakage flow rate.
This leakage <i>l</i> is a non-dimensional number, defined as
<i>l=K<sub>v</sub>(y=0) ⁄ =K<sub>v</sub>(y=1)</i>.
...
<p>
This section describes how valves can be configured
...
<p>
The valves in the package
<a href=\"modelica://ProsNet.Fluid.Valves\">
ProsNet.Fluid.Valves</a>
...
<p align=\"center\">
<img alt=\"image\" src=\"modelica://IBPSA/Resources/Images/Fluid/Actuators/valveSchematic.png\">
</p>
<p>
...
<p align=\"center\">
<img alt=\"image\" src=\"modelica://IBPSA/Resources/Images/Fluid/Actuators/valveResponse.png\">
</p>
<p>
...
easier to solve when a controller switches.</p><p><i>This description was copied from the <a href=\"https://github.com/ibpsa/modelica-ibpsa\">IBPSA library</a>&nbsp;with changes.</i></p>
</body></html>"));
