...
model SF222_indep "Example model of a building with loads provided as time series and
...
equation
  ...
  connect(solCol.port_a, tan.fluPorVol[10]) annotation (Line(points={{-560,-477},
          {-572,-477},{-572,-400},{-132,-400},{-132,-12},{-74.5,-12},{-74.5,
          7.62}},  color={0,127,255}));
  ...
  connect(solCol.weaBus, weaDat.weaBus) annotation (Line(
      points={{-560,-447.24},{-560,-400},{-124,-400},{-124,112},{-40,112},{-40,
          130},{-48,130}},
      color={255,204,51},
      thickness=0.5));
  connect(pump.port_b, tan.fluPorVol[6]) annotation (Line(points={{-370,-463},{
          -108,-463},{-108,-20},{-74.5,-20},{-74.5,-1.82}}, color={0,127,255}));
  ...
  connect(gri.terminal, wolfCGB20_GC1.term_p) annotation (Line(points={{50,-530},
          ...
          1.1}}, color={0,120,120}));
  connect(val3.port_1, wolfCGB20_GC1.port_a) annotation (Line(points={{-230,-20},
          {-230,-24},{-312,-24},{-312,14.4},{-372.187,14.4}}, color={0,127,255}));
  connect(val4.port_1, wolfCGB20_GC1.port_b) annotation (Line(points={{-162,
          -140},{-162,-144},{-296,-144},{-296,40},{-373.573,40},{-373.573,36.1}},
        color={0,127,255}));
  connect(ChpControl.CHPON, wolfCGB20_GC1.CBOn1) annotation (Line(points={{
          -561.88,42},{-508.287,42},{-508.287,36.8},{-454.693,36.8}}, color={
          255,0,255}));
  connect(realExpression.y, wolfCGB20_GC1.ControlIn) annotation (Line(points={{
          -483,6},{-457.813,6},{-457.813,28.05}}, color={0,0,127}));
