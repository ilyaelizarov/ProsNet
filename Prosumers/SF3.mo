...
model SF3 "Example model of a building with loads provided as time series and
  ...
  Modelica.Fluid.Interfaces.FluidPort_b port_b1
    ...
    annotation (Placement(transformation(extent={{86,202},{106,222}})));
equation
  ...
  connect(booleanExpression1.y, solarThermalControl.Use) annotation (Line(
        points={{-580.9,-179},{-580.9,-177.76},{-552.96,-177.76}}, color={255,0,
          255}));
  connect(port_a1, tan.fluPorVol1[2]) annotation (Line(points={{70,212},{70,14},
          {41.46,14},{41.46,-18.32}},
                                    color={0,127,255}));
  connect(port_b1, tan.fluPorVol1[4]) annotation (Line(points={{96,212},{96,-16},
          {38,-16},{38,-8},{41.46,-8},{41.46,-13.44}},
                                                  color={0,127,255}));
  annotation (
    Icon(
      coordinateSystem(
        preserveAspectRatio=false, extent={{-460,-480},{380,120}}), graphics={
          Bitmap(extent={{-350,-404},{378,238}}, fileName=
              "modelica://ProsNet/../thesis/report 7/New folder/sf3.JPG"),
        Rectangle(
